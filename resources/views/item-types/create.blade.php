...
<div class="max-w-2xl">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Add New Item Type</h2>
        <p class="text-sm text-gray-600 mt-1">Create a new inventory item type</p>
    </div>
            ...
            <form action="{{ route('item-types.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @error('min_stock')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">Alert will be shown when stock falls below this value</p>
                </div>

                <div class="form-group">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_active" id="is_active" value="1" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" {{ old('is_active', true) ? 'checked' : '' }}>
